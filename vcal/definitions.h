#define SUPPORTED_VCAL_DATABASE_VERSION 2
...
enum VCAL_RETURN {
    VCAL_SUCCESSFUL = 0, ///< Successful
	VCAL_BAD_FILE,	///< File couldn't be read or open or does not exist.
	VCAL_DATABASE_ERROR,	///<
	VCAL_ERR_DB_VERSION_IS_DIFFERENT
};

enum PredFlag {//pred flag of HEVC MVs
    PF_INTRA = 0,
    PF_L0,
    PF_L1,
    PF_BI,
